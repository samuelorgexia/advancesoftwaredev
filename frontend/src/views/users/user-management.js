 ...
 function Usermanagement(prop){ 
  ...
  const [successPop,setSuccessPop]=useState(false);
    ...
    return(
        ...
        <li class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"><button onClick={()=>setProfilePop(true)}  >User Details</button></li>
    </ul>
    ...
    <Transition.Root show={profilePop} as={Fragment}>
      <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto"  onClose={setProfilePop}>
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            as={Fragment}
            enter="ease-out duration-300"
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                    <UserProfilePopup trigger={profilePop}setTrigger={setProfilePop}></UserProfilePopup>
